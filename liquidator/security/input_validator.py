...
class InputValidator:
    ...
    def validate_file_path(self, file_path: str) -> None:
        ...
        try:
            ...
            if isinstance(e, InputValidationError):
                raise
            raise InputValidationError(f"Invalid file path: {file_path}") from e
    ...
    def validate_date_format(self, date_str: str, field_name: str = "date") -> None:
        ...
        try:
            ...
            raise InputValidationError(f"Invalid date format for '{field_name}': {date_str}") from None
    ...
    def _validate_field(self, value: Any, field_name: str, validator_func) -> Any:
        ...
        try:
            ...
            if isinstance(e, InputValidationError):
                raise
            raise InputValidationError(f"Validation error for field '{field_name}': {e}") from e
    ...
    def _validate_positive_integer(self, value: Any) -> int:
        ...
        try:
            ...
            raise InputValidationError("Value must be a valid number") from None
