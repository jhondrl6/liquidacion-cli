...
- **Fase 0 CERRADA en S11 (con DoD 4/5 = 80% verificado en S11.6).** Siguiente fase: **Fase 1** (Tareas 1.A-utils cerrada S12, 1.X cerrada S13, **1.A-plan EN CURSO en S14 — pendiente commit manual del usuario**). Tras commit S14: **Tarea 1.B** (CLI entry point real con Click — `liquidator/cli/main.py`).
