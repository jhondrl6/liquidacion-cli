...
- **Última sesión cerrada:** **S45 — 2026-06-15, Tarea 4.F (cont., housekeeping)**. Documentado en REGISTRY (Bloqueos activos) + CHANGELOG (Known Issues) el gap crónico de CI: 5+ runs consecutivos (S38, S39, S40, S44×2) fallan en step 8 (Tests/pytest) por 36 fails + 15 errors preexistentes de Fase 2+. S43 fue excepción (ruff, resuelto en S44). Estado post-S44: ruff verde, mypy verde, KB freshness verde, **pytest crónicamente rojo**. Item 11 del DoD Fase 4 ("Suite al 100%") sigue abierto. No bloquea 4.F (paso 3, manual). Acción futura: triagear los 36F+15E y abrir tarea dedicada en cleanup post-release.
