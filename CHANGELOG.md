...
- **Fase 0 CERRADA en S11 (con DoD 4/5 = 80% verificado en S11.6).** Siguiente fase: **Fase 1** (1.A-utils S12, 1.X S13, 1.A-plan S14, 1.B S15, 1.C S16, **1.E S17**). Proxima: **Tarea 1.D** (JSONGenerator refactor, desbloqueada por 1.E) o **Tarea 1.G** (R-OP-03, 1 min).
