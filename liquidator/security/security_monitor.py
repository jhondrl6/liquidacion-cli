...
class SecurityMonitor:
    ...
    def log_security_event(self, event_type: str, severity: str, source: str, details: Dict[str, Any] = None) -> SecurityEvent:
        ...
        log_entry = json.dumps(event.to_dict(), indent=2)
    ...
    def check_rate_limit(self, source: str) -> tuple[bool, Optional[str]]:
    ...
    def check_failed_attempts(self, source: str, event_type: str = 'login') -> tuple[bool, Optional[str]]:
    ...
    def detect_compliance_threats(self, compliance_data: Dict[str, Any], source: str) -> List[str]:
        ...
        warnings = compliance_data.get('summary', {}).get('warnings', 0)
    ...
    def auto_block_source(self, source: str, reason: str, duration_seconds: Optional[int] = None) -> None:
    ...
    def cleanup_old_data(self) -> None:
        ...
        old_time = time.time() - self.failed_attempt_window
        old_attempts = [
            (source, event_type) 
